...
# WIDTH = 0.2032                       # Width of the vehicle [m]
...
class MPC_Node(Node):
        ...
        def publish_control(self):
            ...
            drive_msg.drive.speed = SPEED_FACTOR * self.speed

            # Publish the drive command
            self.drive_pub.publish(drive_msg)

            self.get_logger().info('Control: speed=%f, steer=%f' % (SPEED_FACTOR * self.speed, self.steer))
...
def main(args=None):
    ...
    pickle.dump(node.logger, open("/home/glenn/BA/Johannes_MPC_ws/src/mpc/mpc/datalogging_MPC_KS.p", "wb"))
    print("Data saved")
