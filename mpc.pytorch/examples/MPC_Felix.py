...
if __name__ == '__main__':
    ...
    # with open('/home/glenn/BA/Johannes_MPC_KS/config_FTM_Halle_Large_Track_orig.yaml') as file:
    ...
    while not done:
        ...
        if control_count == 10:
            ...
            speed, steer = planner.control(obs['poses_x'][0], obs['poses_y'][0], zero_2_2pi(pi_2_pi(obs['poses_theta'][0])),obs['linear_vels_x'][0], path)
        ...
        # print("Current x: ", obs['poses_x'][0], "Current y: ", obs['poses_y'][0], "Current theta: ", zero_2_2pi(pi_2_pi(obs['poses_theta'][0])), "Current Speed: ", obs['linear_vels_x'][0])
        laptime += step_reward
